...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        if (predicted_character != "none" and 
            ...
            (time.time() - last_added_time) >= 1):  # Check if 1 second has passed
    ...
    # Display the predicted word in a box at the bottom of the frame
    cv2.rectangle(frame, (0, H - 50), (W, H), (255, 255, 255), -1)
    cv2.putText(frame, f"Word: {word}", (10, H - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
